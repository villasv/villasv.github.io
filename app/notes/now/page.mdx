...
Vancouver is cold. Snow is still around somewhat, so I have been riding my bike
less and using public transit more. Either method takes me on average less than
15 minutes to get to work, making my mandated Return To Office 5 days a week
much more bearable than it would be otherwise, so I'm grateful for this fortune
and privilege.
...
This website is going to be the basis for the RSS feed and possibly the
