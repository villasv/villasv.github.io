...
StretchText is an interesting appealing idea: text that can be expanded into
more details if and only if the reader has interest on it. [It][st1]
[keeps][st2] [getting][st3] [rediscovered][st4], though never making it into
wide adoption. Most people never heard of it and those who did have a hard time
...
Why is that? Such an appealing and powerful idea with so little traction. There
...
Poetry is lovely, but it's also hard to write well at the same time an argument
has to be made or an opinion is to be shared. It requires a lot of effort and
it's most often not contributing to the main goal of the writeup.

## Marginal gains

Even if a reader is optimally served by a given level of detail, they will
expand _just to be sure_. The reader cannot tell what is their ideal level of
detail until they shoot past it, as there's usually no means of previewing the
collapsed content. Going further, it's likely that most readers will expand the
vast majority of collapsed content simply out of curiosity (or [FOMO][]) anyway.
...
re-reading sentences to make sense of the influx; and readers that would have
benefited from the terser form will repeatedly experience the regret of
unnecessary expansions before they learn to live with the anxiety of not knowing
...
Given the big costs and possibly negative returns, StretchText is probably going
to remain rare.